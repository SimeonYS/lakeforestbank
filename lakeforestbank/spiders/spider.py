...
from ..items import LlakeforestbankItem
from itemloaders.processors import TakeFirst
import json

pattern = r'(\xa0)?'
base = 'https://www.lakeforestbank.com/content/wintrust/lakeforestbank/en/small-business/resources/financial-education.article.{}.json?limit=10'

class LlakeforestbankSpider(scrapy.Spider):
	name = 'lakeforestbank'
	page = 0
	...
	def parse_post(self, response, date, title):
		...
		item = ItemLoader(item=LlakeforestbankItem(), response=response)
